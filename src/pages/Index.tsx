        ...
        <nav className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold text-primary">Интермед-групп</span>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6 animate-fade-in">
                ...
                <p className="text-xl text-gray-600">
                  ...
                  Быстро, качественно, с соблюдением всех стандартов.
                </p>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  description: 'Медицинский контроль перед началом рабочей смены',
                },
                {
                  icon: 'UserCheck',
                  title: 'Периодические осмотры',
                  description: 'Плановые медицинские обследования сотрудников',
                },
                {
                  icon: 'FileText',
                  title: 'Оформление документов',
                  description: 'Полное документальное сопровождение медосмотров',
                },
                {
                  icon: 'Building2',
